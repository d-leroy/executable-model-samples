...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Petrinet Transition Fire</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link petrinetTrace.Steps.impl.Petrinet_Transition_FireImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link petrinetTrace.Steps.impl.Petrinet_Transition_FireImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link petrinetTrace.Steps.impl.Petrinet_Transition_FireImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Petrinet_Transition_FireImpl extends StepImpl implements Petrinet_Transition_Fire {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Petrinet_Transition_Fire_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected Petrinet_Transition_FireImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.PETRINET_TRANSITION_FIRE;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINET_TRANSITION_FIRE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_TRANSITION_FIRE__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_TRANSITION_FIRE__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINET_TRANSITION_FIRE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_TRANSITION_FIRE__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_TRANSITION_FIRE__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Petrinet_Transition_Fire_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Petrinet_Transition_Fire_AbstractSubStep>(Petrinet_Transition_Fire_AbstractSubStep.class, this, StepsPackage.PETRINET_TRANSITION_FIRE__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public Transition getCaller() {
		return (fr.inria.diverse.sample.petrinet.xpetrinet.petrinet.Transition) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.PETRINET_TRANSITION_FIRE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.PETRINET_TRANSITION_FIRE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.PETRINET_TRANSITION_FIRE__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.PETRINET_TRANSITION_FIRE__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Petrinet_Transition_Fire_AbstractSubStep>)newValue);
				return;
		}
