 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetTrace.States.impl.Place_tokens_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link petrinetTrace.States.impl.Place_tokens_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link petrinetTrace.States.impl.Place_tokens_ValueImpl#getStates <em>States</em>}</li>
 *   <li>{@link petrinetTrace.States.impl.Place_tokens_ValueImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Place_tokens_ValueImpl extends MinimalEObjectImpl.Container implements Place_tokens_Value {
	...
	public void setParent(TracedPlace newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.PLACE_TOKENS_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, PetrinetPackage.TRACED_PLACE__TOKENS_SEQUENCE, TracedPlace.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.PLACE_TOKENS_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, PetrinetPackage.TRACED_PLACE__TOKENS_SEQUENCE, TracedPlace.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatesPackage.PLACE_TOKENS_VALUE__STATES_NO_OPPOSITE:
